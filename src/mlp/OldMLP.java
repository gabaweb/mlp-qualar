...
public class OldMLP {
    ...
    public OldMLP(boolean INPUT, int VARIABLES, int INPUT_WINDOW_SIZE, int HIDDEN_LAYER_NEURONS, int PREDICT_WINDOW_SIZE, ArrayList<NormalizedField> NORM, String DATASET, int EXECUTION, Date DATE) {
